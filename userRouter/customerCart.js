...
router.post("/add", async (req, res) => {
  const { id_customer, id_thuoc_tinh, so_luong, gia, ten_sp, thuong_hieu, hinh_chinh } = req.body;
  ...
  try {
    ...
    if (existingItem) {
      ...
      cart.items.push({ id_thuoc_tinh, so_luong, gia, ten_sp, thuong_hieu, hinh_chinh });
    }
